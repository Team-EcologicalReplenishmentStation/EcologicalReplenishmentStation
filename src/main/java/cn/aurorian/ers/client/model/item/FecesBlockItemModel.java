...
public class FecesBlockItemModel extends GeoModel<FecesBlockItem> {
    ...
    public ResourceLocation getModelResource(FecesBlockItem animatable) {
        return EcologicalReplenishmentStation.prefix(
                "geo/block/" + BuiltInRegistries.BLOCK.getKey(block).getPath() + "_block_entity.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(FecesBlockItem animatable) {
        return EcologicalReplenishmentStation.prefix(
                "textures/block/" + BuiltInRegistries.BLOCK.getKey(block).getPath() + "_block_entity.png");
    }
