...
public class AntiquusHiddenLayer extends GeoRenderLayer<EosuchosaurusAntiquusEntity> {
    public AntiquusHiddenLayer(GeoRenderer<EosuchosaurusAntiquusEntity> entityRendererIn) {
    ...
    public void preRender(
        ...
        bakedModel.getBone("blood").ifPresent(bone -> bone.setHidden(!bloody));
    ...
    public void render(
            PoseStack poseStack,
            EosuchosaurusAntiquusEntity animatable,
            BakedGeoModel bakedModel,
            RenderType renderType,
            MultiBufferSource bufferSource,
            VertexConsumer buffer,
    ...
    @Override
    protected ResourceLocation getTextureResource(EosuchosaurusAntiquusEntity animatable) {
        return EcologicalReplenishmentStation.prefix("textures/entity/eosuchosaurus_antiquus/layer.png");
    }
}
