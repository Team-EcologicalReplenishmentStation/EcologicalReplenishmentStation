...
public class ErsBlocks {
    ...
    public static final RegistryObject<Block> SOUL_CUBE = BLOCKS.register("soul_cube",
    ...
    public static final RegistryObject<Block> SWAMP_DRAGON_NEST = BLOCKS.register("swamp_dragon_nest",
            () -> new SwampDragonNestBlock(Block.Properties.of()
    ...
    public static final RegistryObject<Block> EQUISETUM = BLOCKS.register("equisetum",
