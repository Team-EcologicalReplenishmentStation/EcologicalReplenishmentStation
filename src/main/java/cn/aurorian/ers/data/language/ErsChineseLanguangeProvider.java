...
public class ErsChineseLanguangeProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add(ErsItems.SWAMP_DRAGON_LARGE_BUCKET.get(), "泽龙大桶");
        ...
        add(ErsItems.SWAMP_DRAGON_FECES.get(), "泽龙粪便");
        add(ErsItems.SWAMP_DRAGON_BONE_FECES.get(), "泽龙带骨粪便");
        add(ErsItems.SWAMP_DRAGON_SMALL_FECES.get(), "泽龙小型粪便");
        add(ErsItems.SWAMP_DRAGON_LARGE_FECES.get(), "泽龙大型粪便");
        add(ErsItems.SWAMP_DRAGON_GLASSES_FECES.get(), "泽龙带眼镜粪便");
        add(ErsItems.SWAMP_DRAGON_TEL_FECES.get(), "泽龙带电话粪便");
        add(ErsItems.SOUL_CUBE.get(), "灵魂魔方");
        add(ErsBlocks.SWAMP_DRAGON_NEST.get(), "泽龙巢穴");
        add(ErsBlocks.SWAMP_DRAGON_ARTIFICIAL_NEST.get(), "泽龙人工巢穴");
