...
public class ErsAdvancementProvider extends ForgeAdvancementProvider {
    ...
    private static class ErsAdvancements implements ForgeAdvancementProvider.AdvancementGenerator {
        ...
        public void generate(HolderLookup.@NotNull Provider provider, @NotNull Consumer<Advancement> consumer, @NotNull ExistingFileHelper existingFileHelper) {
            Advancement enterWorld = createAdvancement("enter_world", null, ErsItems.SOUL_CUBE.get(), BACKGROUND_LOCATION, FrameType.TASK, true, true, false)
            ...
            Advancement swamp_dragon_egg = createAdvancement("swamp_dragon_egg", enterWorld, ErsItems.SWAMP_DRAGON_EGG.get(), FrameType.TASK, true, true, true)
                    .addCriterion("has_swamp_dragon_egg", net.minecraft.advancements.critereon.InventoryChangeTrigger.TriggerInstance.hasItems(ErsItems.SWAMP_DRAGON_EGG.get()))
    ...
    private static Advancement.Builder createAdvancement(String name, Advancement parent, ItemLike icon, ResourceLocation backGround, FrameType frame, boolean showToast, boolean announceToChat, boolean hidden) {
        return Advancement.Builder.advancement().parent(parent).display(icon,
                Component.translatable("advancements." + EcologicalReplenishmentStation.MODID  + "." + name + ".title"),
                Component.translatable("advancements." + EcologicalReplenishmentStation.MODID  + "." + name + ".desc"),
