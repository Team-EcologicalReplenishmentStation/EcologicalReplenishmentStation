...
public class AcanthodesMoveControl extends MoveControl {
    ...
    private final AcanthodesChlamydoselachoidesEntity fish;

    public AcanthodesMoveControl(AcanthodesChlamydoselachoidesEntity pMob) {
        super(pMob);
        this.maxTurnX = 85;
        this.maxTurnY = 10;
