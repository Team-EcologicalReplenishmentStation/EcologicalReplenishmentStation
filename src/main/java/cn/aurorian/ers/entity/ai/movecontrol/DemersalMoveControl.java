...
public class DemersalMoveControl extends SmoothSwimmingMoveControl {
    ...
    private static final float IDLE_SINK_FORWARD_SPEED = 0.12F;
    ...
    public void tick() {
        ...
        if (this.operation == Operation.MOVE_TO && !this.mob.getNavigation().isDone()) {
            ...
            if (this.mob.isInWater() && this.mob.getDeltaMovement().y < -1.0E-4) {
                float $$10 = (float) (this.mob.getAttributeValue(Attributes.MOVEMENT_SPEED) * IDLE_SINK_FORWARD_SPEED);
                this.mob.setSpeed($$10);

                float $$11 = Mth.cos(this.mob.getXRot() * 0.017453292F);
                float $$12 = Mth.sin(this.mob.getXRot() * 0.017453292F);
                this.mob.zza = $$11 * $$10;
                this.mob.yya = -$$12 * $$10;
