...
public class AcanthodesChlamydoselachoidesEntity extends ErsWaterAnimal
        implements ErsEntity<AcanthodesChlamydoselachoidesEntity>, Bucketable {
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllerRegistrar) {
        AnimationController<AcanthodesChlamydoselachoidesEntity> main =
        ...
        AnimationController<AcanthodesChlamydoselachoidesEntity> extra = new AnimationController<>(
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(
                ...
                new NearestAttackableTargetGoal<>(
                        ...
                        true,
                        entity ->
                                entity.hasEffect(ErsMobEffects.BLEEDING.get()) && entity.getType() != this.getType()));
    }
    ...
    public @Nullable SpawnGroupData finalizeSpawn(
        ...
        if (this.random.nextFloat() < 0.001f) {
            var customNameList = new String[] {"Flanker"};
