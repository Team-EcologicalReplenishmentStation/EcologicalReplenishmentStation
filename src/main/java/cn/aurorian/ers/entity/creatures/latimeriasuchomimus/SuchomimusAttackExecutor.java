...
public class SuchomimusAttackExecutor {
    ...
    public void executeHold(MobAttack attack, LatimeriaSuchomimusEntity entity) {
        ...
        if (!entity.level()
                .getFluidState(new BlockPos(
                        (int) entity.getMoveControl().getWantedX(),
                        (int) entity.getMoveControl().getWantedY(),
                        (int) entity.getMoveControl().getWantedZ()))
                .is(FluidTags.WATER)) {
            entity.tryFindWaterGoal.start();
        }
        entity.getNavigation()
                .moveTo(
                        entity.getMoveControl().getWantedX(),
                        entity.getMoveControl().getWantedY(),
                        entity.getMoveControl().getWantedZ(),
                        1.0D);
