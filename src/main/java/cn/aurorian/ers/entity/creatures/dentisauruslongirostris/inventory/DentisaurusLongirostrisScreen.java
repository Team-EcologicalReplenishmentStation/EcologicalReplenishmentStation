...
public class DentisaurusLongirostrisScreen extends AbstractContainerScreen<DentisaurusLongirostrisContainerMenu> {
    ...
    private static final ResourceLocation TEXTURE =
            EcologicalReplenishmentStation.prefix("textures/container/swamp_dragon_container.png");
    private static final ResourceLocation ELITE_TEXTURE =
            EcologicalReplenishmentStation.prefix("textures/container/swamp_dragon_container_elite.png");

    public DentisaurusLongirostrisScreen(
            DentisaurusLongirostrisContainerMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
