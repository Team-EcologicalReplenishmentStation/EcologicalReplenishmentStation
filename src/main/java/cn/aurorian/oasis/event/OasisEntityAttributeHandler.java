...
public class OasisEntityAttributeHandler{
    ...
    public static void registerAttributes(EntityAttributeCreationEvent event) {
        ...
        event.put(OasisEntities.TUBUNASUS_CLYDEROTUNDA.get(), TubunasusClyderotundaEntity.createAttributes().build());
        event.put(OasisEntities.PYGOPODUS_ANNULATUM.get(), PygopodusAnnulatumEntity.createAttributes().build());
    }

    @SubscribeEvent
    public static void registerSpawnPlacements(SpawnPlacementRegisterEvent event) {
        event.register(OasisEntities.PYGOPODUS_ANNULATUM.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Animal::checkAnimalSpawnRules, SpawnPlacementRegisterEvent.Operation.REPLACE);
    }
