...
public class TubunasusClyderotundaScreen extends AbstractContainerScreen<TubunasusClyderotundaContainerMenu> {
    ...
    private static final ResourceLocation MALE_TEXTURE = ResourceLocation.fromNamespaceAndPath(Oasis.MODID, "textures/container/clyderotunda_male_container.png");
    private static final ResourceLocation FEMALE_TEXTURE = ResourceLocation.fromNamespaceAndPath(Oasis.MODID, "textures/container/clyderotunda_female_container.png");

    public TubunasusClyderotundaScreen(TubunasusClyderotundaContainerMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
