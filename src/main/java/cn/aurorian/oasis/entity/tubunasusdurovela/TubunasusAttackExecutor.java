...
public class TubunasusAttackExecutor {
    ...
    public void executeTubunasusAttack(MobAttack attack, ErsTamableVehicle<?> mount) {
        if(!mount.isVehicle())
            return;
    ...
    public void executeTubunasusTurningAttack(MobAttack attack, ErsTamableVehicle<?> mount) {
