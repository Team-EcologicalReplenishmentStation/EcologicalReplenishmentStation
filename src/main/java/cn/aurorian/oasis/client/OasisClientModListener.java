...
import cn.aurorian.oasis.entity.tubunasusclyderotunda.invertory.TubunasusClyderotundaScreen;
...
public class OasisClientModListener {
    ...
    public static void registerRenderers(final EntityRenderersEvent.RegisterRenderers event) {
        ...
        event.registerBlockEntityRenderer(OasisBlockEntities.DUROVELA_SPECIMEN_BLOCK_ENTITY.get(),  (BlockEntityRendererProvider.Context context) -> new GeoBlockRenderer<>(new DurovelaSpecimenModel()));
    }

    @SubscribeEvent
    public static void registerRenderers(final FMLClientSetupEvent event) {
        event.enqueueWork(() -> MenuScreens.register(OasisContainers.DUROVELA_CONTAINER.get(), TubunasusDurovelaScreen::new));
        event.enqueueWork(() -> MenuScreens.register(OasisContainers.CLYDEROTUNDA_CONTAINER.get(), TubunasusClyderotundaScreen::new));
    }
}
