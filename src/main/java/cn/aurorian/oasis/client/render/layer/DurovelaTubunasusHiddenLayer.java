...
public class DurovelaTubunasusHiddenLayer extends GeoRenderLayer<TubunasusDurovelaEntity> {

    public DurovelaTubunasusHiddenLayer(GeoRenderer<TubunasusDurovelaEntity> entityRendererIn) {
