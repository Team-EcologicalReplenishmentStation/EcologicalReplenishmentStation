...
public class DurovelaModel extends OasisModel<TubunasusDurovelaEntity> {
    @Override
    public ResourceLocation getModelResource(TubunasusDurovelaEntity entity) {
        ...
        } else return super.getModelResource(entity);
    }

    @Override
    public ResourceLocation getTextureResource(TubunasusDurovelaEntity entity) {
        String base = "textures/entity/tubunasus_durovela/base";

        if (entity.isBaby()) {
            base = "textures/entity/tubunasus_durovela/baby";
        } else {
            if (entity.hasCustomName()) {
                if (entity.getCustomName().getString().equals("dark")) return Oasis.prefix(base + "_dark.png");
    ...
    public ResourceLocation getAnimationResource(TubunasusDurovelaEntity entity) {
        if (entity.isBaby()) return Oasis.prefix("animations/entity/tubunasus_durovela_baby.animation.json");
